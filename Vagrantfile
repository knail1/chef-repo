...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "knail1-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/stocrates"
  #   chef.validation_client_name = "stocrates-validator"
  #   chef.validation_key_path = ".chef/stocrates-validator.pem"
  # end
end
